...
• Use the clear button to remove data from the interface`
    },
    {
      ...
      content: `Optimize your experience with these performance tips.

For Best Performance:
• Process large datasets in smaller batches (500-1000 rows)
• Use the latest version of Chrome, Firefox, or Edge
• Clear browser cache regularly
• Keep your browser updated for optimal performance

Handling Large Files:
• For files over 10,000 rows, consider splitting into batches
• Use the export feature to save intermediate results
• Allow extra processing time for very large datasets

Troubleshooting:
• If the tool seems slow, try clearing your browser cache
• Refresh the page if you encounter any glitches
• Check your internet connection for stable operation
• Use the Clear button to reset the tool between sessions`
    },
    {
      id: 'support',
      title: 'Support & FAQ',
...
Q: Why are my results showing no conflicts?
A: This means all your styles have unique parent ASINs, which is the desired state.

Q: Can I process millions of rows?
A: The tool is optimized for datasets up to 10,000 rows. For larger datasets, process in batches.

Q: Why do I see the same ASIN multiple times?
A: Duplicate ASINs for the same style are automatically ignored in conflict detection.

Q: Can I undo a clear action?
A: No, clearing removes all data. Export results before clearing if you need to keep them.

Q: Does the tool work with non-Amazon data?
A: Yes, you can use any alphanumeric identifiers, though the tool is optimized for Amazon formats.

Need more help?
• Check the documentation for detailed guides
• Contact your system administrator for internal support
• Review the data format guidelines for proper formatting

Response Time:
• Most operations complete within 1-2 seconds
• Larger datasets may take 5-10 seconds
• Processing time depends on your computer's performance`
    },
    {
      ...
      content: `Increase your productivity with these keyboard shortcuts.
...
SKU Tool Shortcuts:
• Ctrl/Cmd + Enter - Process SKUs
• Ctrl/Cmd + Shift + C - Clear all data

ASIN Tool Shortcuts:
• Ctrl/Cmd + Enter - Run ASIN check
• Ctrl/Cmd + Shift + C - Clear all data
• Ctrl/Cmd + Shift + E - Export results to CSV

Navigation Shortcuts:
• Alt + 1 - Navigate to Dashboard
• Alt + 2 - Navigate to Tools
• Alt + D - Focus Documentation (when open)

Note: Shortcuts may vary depending on your browser and operating system. Some shortcuts might conflict with browser defaults.`
    }
  ];
